...
exports.twoStep = function(req, res) {
  res.render(VIEWS_DIR + 'twoStepP1', { bioId: req.params.bioId });
};
...
exports.twoStepTwo = function(req, res) {
  res.render(VIEWS_DIR + 'twoStepP2', { bioId: req.params.bioId });
};
...
exports.getCongressForm = function(req, res) {
  res.render(VIEWS_DIR + req.params.bioId, { bioId: req.params.bioId });
};
